...
DROP DATABASE IF EXISTS servicios_escolares;
CREATE DATABASE servicios_escolares;
...
INSERT INTO carrera(nombre_carrera, estatus) VALUES ("INGENIERIA EN TECNOLOGÍAS DE LA INFORMACIÓN E INNOVACIÓN CON TSU EN ENTORNOS VIRTUALES Y NEGOCIOS DIGITALES", 1);
INSERT INTO carrera(nombre_carrera, estatus) VALUES ("INGENIERIA EN TECNOLOGÍAS DE LA INFORMACIÓN E INNOVACIÓN CON TSU EN INFRAESTRUCTURA DE REDES DIGITALES", 1);
INSERT INTO carrera(nombre_carrera, estatus) VALUES ("INGENIERIA EN TECNOLOGÍAS DE LA INFORMACIÓN E INNOVACIÓN CON TSU EN DESARROLLO DE SOFTWARE MULTIPLATAFORMA", 1);
INSERT INTO carrera(nombre_carrera, estatus) VALUES ("INGENIERIA EN TECNOLOGÍAS DE LA INFORMACIÓN E INNOVACIÓN CON TSU INTELIGENCIA ARTIFICIAL", 1);
INSERT INTO carrera(nombre_carrera, estatus) VALUES ("INGENIERIA EN TECNOLOGÍAS DE LA INFORMACIÓN E INNOVACIÓN CON TSU EN CIENCIA DE DATOS", 1);
INSERT INTO carrera(nombre_carrera, estatus) VALUES ("INGENIERIA EN MECATRÓNICA CON TSU EN SISTEMAS DE MANUFACTURA FLEXIBLE", 1);
INSERT INTO carrera(nombre_carrera, estatus) VALUES ("INGENIERIA EN MECATRÓNICA CON TSU EN OPTOMECATRÓNICA", 1);
INSERT INTO carrera(nombre_carrera, estatus) VALUES ("INGENIERIA EN MECATRÓNICA CON TSU EN AUTOMATIZACIÓN", 1);
INSERT INTO carrera(nombre_carrera, estatus) VALUES ("INGENIERÍA INDUSTRIAL CON TSU SISTEMAS PRODUCTIVOS", 1);
INSERT INTO carrera(nombre_carrera, estatus) VALUES ("INGENIERÍA INDUSTRIAL CON TSU EN MOLDEO DE PLÁSTICOS", 1);
INSERT INTO carrera(nombre_carrera, estatus) VALUES ("INGENIERÍA INDUSTRIAL CON TSU EN GESTIÓN Y PRODUCTIVIDAD DE CALZADO", 1);
INSERT INTO carrera(nombre_carrera, estatus) VALUES ("INGENIERÍA INDUSTRIAL CON TSU EN AUTOMOTRÍZ", 1);
